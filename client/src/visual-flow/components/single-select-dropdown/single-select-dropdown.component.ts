...
@Component({
    imports:[CommonModule, MatSelectModule, MatIconModule, FormsModule, MatFormFieldModule, MatInputModule, DropdownSearchInputFocusDirective],
    selector: 'vd-single-select-dropdown',
